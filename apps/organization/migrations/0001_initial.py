    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2019, 12, 11, 15, 56, 37, 400707), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '城市',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fav_nums', models.IntegerField(default=0, verbose_name='收藏人数')),
                ('click_nums', models.IntegerField(default=0, verbose_name='点击数')),
                ('add_time', models.DateTimeField(default=datetime.datetime(2019, 12, 11, 15, 56, 37, 402716), verbose_name='添加时间')),
